...
const CLASS_MATCH = /(\bclass|className)\s*=\s*["'`](.*?)["'`]/g;
...
export function activityToTranslationInput(activity: Activity, pathInfo: PathInfo, currentValue: string): TranslationInput {
