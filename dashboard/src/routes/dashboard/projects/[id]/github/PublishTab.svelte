<script lang="ts">
	...
	async function handlePublishClick() {
		...
		try {
			...
			toast.push('Changes published to GitHub! ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ', {
				theme: {
