...
>
	<div class="flex flex-col w-1/2 items-center min-w-[800px] gap-[20px]">
		...
		<div class="flex flex-row w-full h-[fit-content] rounded-none bg-black p-6 border gap-[40px]">
			...
			<div class="text-white flex flex-col items-start m-0 p-5 gap-2">
				...
				>
				<a
					class="text-sm text-brand text-[#ef4444] hover:underline flex flex-row items-center"
	...
	<div class="flex flex-row text-primary mt-6 gap-[18px]">
		...
		<a
			class="flex flex-row items-center rounded-xs bg-red-500/20 py-2 px-3 text-red-500 w-fit hover:bg-red-500/30 ml-[18px]"
