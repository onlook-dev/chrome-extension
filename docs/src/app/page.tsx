  ...
  return (
    <main className="flex flex-col gap-[32px] h-screen items-center justify-center overflow-auto m-10">
      ...
      <div className="w-full max-w-lg  flex flex-col gap-3">
        ...
        <p className="m-0 p-0 text-left ">Onlook is a browser extension that lets anyone edit any webpage, then publish their edits to a codebase without writing any code themselves. Designers can build directly on the website itself, and Developers can focus on building more than User Interfaces.</p>
      </div>
